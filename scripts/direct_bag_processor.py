...
class DirectBagProcessor:
    ...
    def save_results(self):
        ...
        with open(report_file, 'w') as f:
            ...
            f.write("注意: 这是基于bag包大小估算的轨迹\n")
            f.write("实际处理需要完整的ROS环境\n\n")
            f.write("下一步建议:\n")
            f.write("1. 安装完整的ROS 1环境\n")
            f.write("2. 使用rosbag工具分析bag包内容\n")
            f.write("3. 根据实际话题类型选择合适的处理节点\n")
...
def main():
    ...
    if processor.process_bag():
        ...
        print("1. 查看生成的结果文件")
        print("2. 运行绘图脚本可视化轨迹")
        print("3. 运行分析脚本查看统计信息")
        print("4. 安装完整ROS环境进行实际处理")
    else:
        print(" 处理失败")
